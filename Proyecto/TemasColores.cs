...
namespace Proyecto
{
    internal class TemasColores
    {
        ...
        public static List<string> listaColores = new List<string>() {
           ...
           // "#FF5722", // Naranja Profundo // me gusta
           // "#607D8B", // Gris Azulado
           // "#FF9800", // Naranja
            "#9C27B0", // Púrpura // me gusta
           // "#2196F3", // Azul
           //"#EA676C", // Coral Claro
            "#E41A4A", // Carmesí // me gusta
          //  "#5978BB", // Azul Yonder
          // "#018790", // Laguna Azul
           "#0E3441", // Gris Pizarra Oscuro // me gusta
         // "#00B0AD", // Verde Azulado Claro
          ...
          //  "#8BC240", // Verde Amarillo
            "#364D5B", // Carbón // me gusta
         //   "#C7DC5B", // Verde Amarillo
         //   "#0094BC", // Azul Pacífico
            //"#E4126B", // Magenta
            "#43B76E", // Verde Mar Medio // megusta
          //  "#7BCFE9", // Azul Cielo
            "#B71C46"  // Granate
        };
